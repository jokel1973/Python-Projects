...
def load_gui(self):
    ...
    #self.1b1_phone = tk.Label(self.master,text='Phone Number:')
    #self.lbl_phone.grid(row=4, column=0,padx=(27,0), pady=(10,0), sticky=N+W)
    self.lbl_email = tk.Label(self.master, text='Email Address: ')
    self.lbl_email.grid(row-6, column-0, padx-(27,), pady-(10,0), sticky-N+W)
    self.lbl_user = tk.Label(self.master, text='User:')
    self.lb1_user.grid(row=0, column=2, padx=(0,0) , pady=(10,0), sticky=N+W)
    
    self.txt_fname = tk.Entry(self.master, text='')
    self.txt_fname.grid(row-1, column-0, rowspan-1, columnspan-2, padx-(30, 40), pady-(0, 0), sticky-N+E+W)
    self.txt_lname = tk.Entry(self.master, text='')
    self.txt_lname.grid (row=3, column=0, rowspan=1, columnspan=2, padx=(30, 40) , pady=(0, 0), sticky=N+E+N)
    ...
    self.scrollbar1.config(command=gelf.1stList1.yview)
    ...
    self.btn close.grid (row=8, column=4, columnspan=1, padx=(15, 0), pady=(45, 10) , sticky=E)
