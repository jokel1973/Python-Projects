...
#           return variable _means that wer are returning the variable to 
...
def describe_game(name):
    ...
    """
    # meaning if we don already have this user's name
...
def win(nice,mean,name):
    ...
    play_sound("short-crowd-cheer-6713.mp3")
...
def lose(nice,mean,name):
    ...
    play_sound("wah-wah-sad-trombone-6347.mp3")
    # call again functionand pass in our variable
    again(nice,mean,name)
